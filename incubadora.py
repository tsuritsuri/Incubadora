...
"")
    ...
    def terminar(self):
        ...
        self.lcdPeso.display("Off")
        self.lcdBebe.display("Off")
    ...
    def iniciar(self):
        ...
        self.arthrrun2 = True
        self.reanudar()
        print("Comunicación serial reabierta")
        self.leerarduino()
        self.escribirarduino()
        self.lcdReal.display(self.tempreal)
        self.lcdPeso.display(self.pesobebe)
        self.lcdBebe.display(self.tempbebe)
        self.lcdReal.repaint()
